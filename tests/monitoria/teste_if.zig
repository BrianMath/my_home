...
pub export var idade1: c_ushort = 20;
pub export var idade2: c_ushort = 40;
pub export var min_idade: c_ushort = @import("std").mem.zeroes(c_ushort);
pub export fn main() c_int {
    if (@as(c_int, @bitCast(@as(c_uint, idade1))) <= @as(c_int, @bitCast(@as(c_uint, idade2)))) {
        min_idade = idade1;
    } else {
        min_idade = idade2;
    }
    _ = printf("%hu\n", @as(c_int, @bitCast(@as(c_uint, min_idade))));
    return 0;
}
